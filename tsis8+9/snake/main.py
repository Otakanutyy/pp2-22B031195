...
class SNAKE:
    def __init__(self):
        ...
        self.head_up = pg.image.load('headup.png').convert_alpha()
        self.head_down = pg.image.load('headdown.png').convert_alpha()
        self.head_right = pg.image.load('headright.png').convert_alpha()
        self.head_left = pg.image.load('headleft.png').convert_alpha()
		
        self.tail_up = pg.image.load('tailup.png').convert_alpha()
        self.tail_down = pg.image.load('taildown.png').convert_alpha()
        self.tail_right = pg.image.load('tailright.png').convert_alpha()
        self.tail_left = pg.image.load('tailleft.png').convert_alpha()

        self.body_vertical = pg.image.load('bodyver.png').convert_alpha()
        self.body_horizontal = pg.image.load('bodyhor.png').convert_alpha()

        self.body_tr = pg.image.load('body3.png').convert_alpha()
        self.body_tl = pg.image.load('body4.png').convert_alpha()
        self.body_br = pg.image.load('body2.png').convert_alpha()
        self.body_bl = pg.image.load('body1.png').convert_alpha()
        self.crunch_sound = pg.mixer.Sound('eats.mp3')
...
class MAIN:
    def __init__(self):
        ...
        self.fruit=FRUIT()
        self.dead=False
        self.dead_sound = pg.mixer.Sound('dead.mp3')
    ...
    def draw_all(self):
        if welcomescreen:
            ...
            text = "SCORE:"+str(rat_n*2+apple_n)
